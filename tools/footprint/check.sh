...
check 'gunzip: pushed in, buffer out' push 'decompress gzip checksum concat stored fixed dynamic'
check '- without concat and checksum' push 'decompress gzip stored fixed dynamic'
check '- fixed blocks only' push 'decompress gzip fixed'
check 'gzip: buffer in, buffer out' compress 'compress gzip'
check 'gzip: stream in, stream out' compress-stream 'compress gzip'
check 'gzip: pushed in, stream out' compress-push 'compress gzip'
exit $status
